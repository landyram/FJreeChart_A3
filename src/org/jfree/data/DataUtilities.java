...
/**
 * Utility methods for use with some of the data classes (but not the datasets, see {@link
 * DatasetUtilities}).
 */
public abstract class DataUtilities {

  /**
   * Returns the sum of the values in one column of the supplied data table. With invalid input, a
   * total of zero will be returned.
   *
  ...
  /**
   * Returns the sum of the values in one row of the supplied data table. With invalid input, a
   * total of zero will be returned.
   *
   * @param data the table of values (<code>null</code> not permitted).
  ...
  /**
   * Constructs an array of arrays of <code>Number</code> objects from a corresponding structure
   * containing <code>double</code> primitives.
   *
   * @param data An array of <code>double</code> primitives (<code>null</code> not permitted).
   * @return An array of <code>Number</code> objects.
   */
  ...
  /**
   * Returns a {@link KeyedValues} instance that contains the cumulative percentage values for the
   * data in another {@link KeyedValues} instance. The cumulative percentage is each value's
   * cumulative sum's portion of the sum of all the values. <br>
   * eg: <br>
   * Input:<br>
   * <br>
   * Key&nbsp;&nbsp;Value<br>
   ...
   * 2&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.0 ((5 + 9 + 2) / 16)<br>
   *
   * <p>The percentages are values between 0.0 and 1.0 (where 1.0 = 100%).
   *
